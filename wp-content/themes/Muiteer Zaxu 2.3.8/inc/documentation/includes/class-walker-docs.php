...
if ( !class_exists('MuiteerDocs_Walker_Docs') ) :

/**
 * muiteerDocs Docs Walker
 */
class MuiteerDocs_Walker_Docs extends Walker_Page {
    ...
    public function start_lvl( &$output, $depth = 0, $args = array() ) {
        ...
        if ($args['has_children'] && $depth == 0) {
            ...
            // $output .= '<li class="' . implode(' ', $classes) . '"><a href="' . get_permalink(self::$parent_item) . '">' . __('Introduction', 'muiteer') . '</a></li>';
        }
    }
