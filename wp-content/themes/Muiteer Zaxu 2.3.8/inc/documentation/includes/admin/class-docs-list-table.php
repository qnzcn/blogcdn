 ...
 */
class muiteerDocs_Docs_List_Table {
    ...
    function add_meta_box() {
        add_meta_box('op-menu-meta-box-id', __('Helpfulness', 'muiteer'), array($this, 'helpfulness_metabox'), 'docs', 'side', 'core');
    }
    ...
    public function helpfulness_css() {
        ...
        ?>
        <style type="text/css">
            .muiteerdocs-positive {
                color: green;
            }
            .muiteerdocs-negative {
                color: red;
                text-align: right;
            }
        </style>
    ...
    function helpfulness_metabox() {
        ...
        <table style="width: 100%;">
            <tr>
                <td class="muiteerdocs-positive">
                    <span class="dashicons dashicons-thumbs-up"></span>
                    <?php printf( '%d', get_post_meta($post->ID, 'positive', true) ); ?>
                </td>

                <td class="muiteerdocs-negative">
    ...
    public function docs_list_columns($columns) {
        $vote  = array( 'votes' => __('Helpfulness', 'muiteer') );
    ...
    public function docs_list_columns_row($column_name, $post_id) {
        if ('votes' == $column_name) {
            ...
            printf( '<span class="muiteerdocs-positive">%d</span>/<span class="muiteerdocs-negative">%d</span>', $positive, $negative );
        }
    }
