...
class CSFramework extends CSFramework_Abstract {
  ...
  public function admin_page() {
    ...
    echo '<div class="cs-framework cs-option-framework">';
      ...
      echo '<div class="cs-block-left">运行在： WordPress '. get_bloginfo('version') .' / PHP '. PHP_VERSION .'</div>';
      echo '<div class="cs-block-right">&copy; 2017 Theme By <a href="http://www.xintheme.com" target="_blank" style="color: #555;text-decoration: none;">www.xintheme.com</a> </div>';
      echo '<div class="clear"></div>';
