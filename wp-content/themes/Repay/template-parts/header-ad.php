...
<body class="page-template-page-notitle-headerad">
<div>
	<!-- 悬浮导航 -->
	...
	<div class="container">
		...
		<div class="header-upper" style="height: <?php echo xintheme('logo_height');?>px">
			...
			<div class="logo-right align-items-center" style="height: <?php echo xintheme('logo_height');?>px">
				<div class="ad">
					<a href="<?php echo xintheme('header_ad_url');?>" target="_blank" rel="nofollow">
						<img src="<?php echo xintheme_img('header_ad','');?>" alt="">
					</a>
				</div>
			</div>
		</div>
