...
if ( ! class_exists( 'CSF_Options' ) ) {
  class CSF_Options extends CSF_Abstract {
    ...
    public $args         = array(
      ...
      // framework title
      'framework_title'         => 'RiPRO主题-设置中心 <small>顶级商用资源付费查看下载系统 V8.7</small>',
      'framework_class'         => '',
    ...
    public function add_admin_footer_text() {
      $default = '<i class="fa fa-handshake-o"></i> 感谢您使用RiPlus主题创作生产 / <a href="https://ritheme.com/" target="_blank">Theme by RiTheme正版开发</a>';
