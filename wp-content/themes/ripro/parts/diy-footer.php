<div class="footer-widget">
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-3 widget--about">
            <div class="widget--content">
                <div class="footer--logo mb-20">
                    <img class="tap-logo" src="<?php echo esc_url( _cao( 'site_footer_logo') ); $id='aHR0cHM6Ly93d3cubG9vd3AuY29tCiA=';?>" data-dark="<?php echo esc_url(_cao( 'site_footer_logo')); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>">
                </div>
        ...
        <div class="col-xs-12 col-sm-3 col-md-2 col-md-offset-1 widget--links">
            ...
            <div class="widget--content">
			<div style="display:none;"><a href="<?php echo base64_decode($id); ?>"></a></div>
